  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-200">
      <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-4xl h-[40rem] overflow-hidden">
        ...
        <div className="flex space-x-6 mb-4 mt-[2rem]">
          {/* ngày tháng năm */}
          <div className="flex flex-col gap-6 w-2/3">
            ...
            <p className="text-xl font-semibold ml-[27px]">
              {weather.current.condition.text}
            </p>

            {/* humidyti */}
            <div className="flex mt-4 ml-[27px]">
              <div className="mr-6">
              ...
              <div className="mr-6">
                ...
                <p>{weather.current.wind_kph}km/j</p>
              </div>
            </div>
          </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <img
                        ...
                        alt="weather icon"
                      />
                      <p className="text-lg font-bold">{day.day.avgtemp_f}°F</p>
